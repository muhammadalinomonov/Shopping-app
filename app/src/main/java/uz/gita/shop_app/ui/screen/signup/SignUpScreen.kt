...
class SignUpScreen : AppScreen() {
    ...
    override fun Content() {
        val screenModel: SignUpContract.Model = getScreenModel<SignUpModel>()
        ...
        SignUpContent(screenModel::onEventDispatcher)
    }

    @OptIn(ExperimentalMaterial3Api::class)
    @Composable
    fun SignUpContent(eventDispatcher: (SignUpContract.Intent) -> Unit) {
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            Column(
                ...
                Row(
                    ...
                    IconButton(onClick = { eventDispatcher(SignUpContract.Intent.Back) }) {
                ...
                Button(
                    ...
                    onClick = {
                        eventDispatcher(SignUpContract.Intent.LoginUser(emailInput, passwordInput))
                    }) {
                    Text(text = "Sign up")
                }
            }
